...
const industries = ["Forex Trading Algorithms", "MetaTrader 4/5 Expert Advisors", "Prop Firm Passing Bots", "Forex VPS Solutions", "Trading Signal Generators"];
...
async function generateSeedTopicsBatch(batchSize = 20) {
  ...
  const prompt = `
You are a Forex Automation Specialist for AITraderForex. Focus on strategy win rates, latency, VPS requirements, prop firm compatibility, and risk management parameters.
